...
function onStepValidate(props) {
  return function updateCtaStatus() {
    ...
    const ctas = props.el.querySelectorAll('.webinar-creation-form-panel-wrapper a');
...
function renderFormNavigation(props, prevStep, currentStep) {
  const nextBtn = props.el.querySelector('.webinar-creation-form-ctas-panel .next-button');
  const backBtn = props.el.querySelector('.webinar-creation-form-ctas-panel .back-btn');
  const frags = props.el.querySelectorAll('.fragment');
...
function initFormCtas(props) {
  ...
  ctaRow.classList.add('webinar-creation-form-ctas-panel');

  const forwardActionsWrappers = ctaRow.querySelectorAll(':scope > div');

  const panelWrapper = createTag('div', { class: 'webinar-creation-form-panel-wrapper' }, '', { parent: ctaRow });
  const backwardWrapper = createTag('div', { class: 'webinar-creation-form-backward-wrapper' }, '', { parent: panelWrapper });
  const forwardWrapper = createTag('div', { class: 'webinar-creation-form-forward-wrapper' }, '', { parent: panelWrapper });
...
function updateCtas(props) {
  const formCtas = props.el.querySelectorAll('.webinar-creation-form-ctas-panel a');
