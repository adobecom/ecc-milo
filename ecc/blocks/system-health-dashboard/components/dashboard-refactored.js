...
export default class SystemHealthDashboardRefactored extends LitElement {
  static properties = {
    data: { type: Object },
...
customElements.define('system-health-dashboard-refactored', SystemHealthDashboardRefactored);
