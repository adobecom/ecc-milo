...
export const EVENT_DATA_FILTER = {
  ...
  speakers: { type: 'array', cloneable: true, submittable: false },
  sponsors: { type: 'array', cloneable: true, submittable: false },
  ...
  venue: { type: 'object', cloneable: true, submittable: false },
  ...
  hostEmail: { type: 'string', cloneable: false, submittable: true },
