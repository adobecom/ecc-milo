...
export class EventsGnavPage extends GnavPage {
  ...
  async clickNavItem(item) {
    const selector = `.feds-nav .feds-navItem:nth-child(${item + 1})`;
  ...
  SubMenu(menu) {
    ...
    if (typeof menu === 'number') {
      ...
      selector = `.feds-navItem a[daa-ll*="${menu}"][aria-haspopup="true"]`;
    }
